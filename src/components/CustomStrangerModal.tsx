  ...
  const handleGenerateAiPack = async () => {
    ...
    try {
      ...
      if (data.strangers && Array.isArray(data.strangers)) {
        ...
        sound.playStreak();
        setSuccessMsg(`Generated ${mapped.length} new AI strangers!`);
        setTimeout(() => {
          setSuccessMsg('');
          onClose();
        }, 2000);
      ...
      setAiError(err.message || 'Error generating AI strangers.');
    } finally {
      ...
      <div className="bg-white border-2 border-[#e5e5e5] border-b-4 w-full max-w-lg rounded-3xl p-6 shadow-xl relative space-y-5 animate-fade-in">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs font-bold text-slate-600">
            Add photos of your friends, family, or generate AI profiles with Gemini! ✏️
          </p>
        </div>
        ...
        {/* Tab 2: AI Pack Generator */}
        {activeTab === 'ai' && (
          <div className="space-y-4 pt-1">
            <div className="space-y-1">
              <label className="text-xs font-cartoon font-black text-slate-700">
                Choose AI Stranger Theme
              </label>
              <select
                value={aiTheme}
            ...
            <p className="text-xs font-bold text-slate-600">
              Gemini will generate 5 brand new stranger profiles complete with realistic backstory details!
            </p>
            ...
            >
              ...
              <span>{isGeneratingAi ? 'Generating AI Profiles...' : 'Generate 5 AI Strangers'}</span>
            </button>
