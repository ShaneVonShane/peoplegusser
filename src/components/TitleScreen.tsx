    ...
    <div className="min-h-[calc(100vh-68px)] py-6 px-4 flex flex-col justify-between select-none">
      <div className="max-w-4xl mx-auto w-full space-y-7">
        ...
        <div className="text-center space-y-3 pt-1">
          ...
          <p className="text-slate-600 text-base sm:text-xl max-w-xl mx-auto font-bold leading-snug">
            Look at the portrait photo, pick the right name, and climb the high scores! ✏️🎨
          </p>
          ...
          <div className="flex items-center justify-center gap-3 sm:gap-6 pt-2">
            {[
              ...
              <div
                key={i}
                className={`relative w-24 h-32 sm:w-30 sm:h-38 rounded-3xl overflow-hidden border-2 border-[#e5e5e5] border-b-4 bg-white p-1.5 shadow-sm transform transition-transform hover:scale-110 cursor-pointer ${img.rotation}`}
              >
                <div className="w-full h-full rounded-2xl overflow-hidden border border-[#e5e5e5] relative">
                  ...
                  <div className={`absolute inset-x-1 bottom-1 ${img.badgeColor} border-b-2 rounded-xl py-0.5 px-1 text-center shadow-xs`}>
                    <span className="text-[12px] font-cartoon font-black">
                      {img.name}?
                    </span>
                  </div>
                </div>
        ...
        <div className="pt-2 pb-1 text-center max-w-xl mx-auto">
          <button
            onClick={handlePlay}
        ...
        {/* Game Mode Selector - Duolingo 3D Cards */}
          ...
          <div className="flex items-center justify-between gap-2 flex-wrap sm:flex-nowrap">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-cartoon font-black bg-[#1cb0f6] hover:bg-[#3dbbf7] text-white border-b-4 border-[#1899d6] active:border-b-0 active:translate-y-0.5 px-4 py-2 rounded-2xl cursor-pointer shadow-sm transition-all"
              >
            ...
            <div
              ...
              className={`relative p-5 rounded-3xl border-2 transition-all duration-200 cursor-pointer ${
                selectedMode === 'classic'
                  ...
                  : 'bg-white border-[#e5e5e5] border-b-4 hover:bg-[#f7f9fa]'
              }`}
            >
        ...
        {/* Overall Player Stats Board */}
        <div className="bg-white border-2 border-[#e5e5e5] border-b-4 rounded-3xl p-4 sm:p-5 shadow-xs space-y-4">
